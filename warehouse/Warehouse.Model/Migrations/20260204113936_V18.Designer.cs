...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Warehouse.Model.CodingPattern", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Warehouse.Model.Goods", b =>
                {
                    ...
                    b.Property<int?>("CodingPatternId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Warehouse.Model.Goods", b =>
                {
                    b.HasOne("Warehouse.Model.CodingPattern", "CodingPattern")
                        .WithMany("Goods")
                        .HasForeignKey("CodingPatternId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("Warehouse.Model.Receipt", b =>
                {
                    b.HasOne("Warehouse.Model.Supplier", null)
                        .WithMany("Receipts")
