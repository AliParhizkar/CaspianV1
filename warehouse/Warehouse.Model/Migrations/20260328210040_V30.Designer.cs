...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Warehouse.Model.GoodsAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<byte>("GoodsAccessType")
                        .HasColumnType("tinyint");

                    b.Property<int>("GoodsId")
                        .HasColumnType("int");

                    b.Property<int?>("GoodsPlacementId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GoodsPlacementId");

                    b.HasIndex("StockRoomId");

                    b.ToTable("GoodsAccesses", "wh");
                });
            ...
            modelBuilder.Entity("Warehouse.Model.GoodsAccess", b =>
                {
                    b.HasOne("Warehouse.Model.Goods", "Goods")
                        .WithMany("PlacementGoodsAccesses")
                        .HasForeignKey("GoodsId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Warehouse.Model.GoodsPlacement", "GoodsPlacement")
                        .WithMany("GoodsAccesses")
                        .HasForeignKey("GoodsPlacementId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("Warehouse.Model.Goods", b =>
                {
                    ...
                    b.Navigation("PlacementGoodsAccesses");
