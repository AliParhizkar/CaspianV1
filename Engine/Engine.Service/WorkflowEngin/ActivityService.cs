...
namespace Caspian.Engine.Service
{
    public class ActivityService : BaseService<Activity>
    {
        public ActivityService(IServiceProvider provider)
            :base(provider)
        {
            RuleFor(t => t.Title).Required(t => t.ActivityType == ActivityType.Task).UniqueAsync("فعالیتی با این عنوان در سیستم ثبت شده است");
            RuleFor(t => t.Name).UniqueAsync("فعالیتی با این نام در سیستم ثبت شده است")
