...
namespace Caspian.Engine.Service
{
    public class DynamicParameterService : BaseService<DynamicParameter>
    {
            ...
            :base(provider)
        {
            ...
            RuleFor(t => t.Title).Required().UniqueAsync("عنوان فارسی باید یکتا باشد.");
            RuleFor(t => t.EnTitle).Required().UniqueAsync("عنوان لاتین باید یکتا باشد").CustomValue(t => t.IsValidIdentifire(), "برای تعریف متغیر فقط از حروف لاتین و عدد استفاده نمایید");
