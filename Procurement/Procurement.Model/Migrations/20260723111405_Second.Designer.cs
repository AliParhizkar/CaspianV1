...
namespace Procurement.Model.Migrations
{
    ...
    [Migration("20260723111405_Second")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Procurement.Model.PriceInquiry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("MultiplePreInvoice")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("PriceInquiries", "pcm");
                });

            modelBuilder.Entity("Procurement.Model.PriceInquiryGoods", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PriceInquiryId");

                    b.ToTable("PriceInquiriesGoods", "pcm");
                });
            ...
            modelBuilder.Entity("Warehouse.Model.GoodsProperties", b =>
                {
                    ...
                    b.ToTable("GoodsProperties", "wh", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Warehouse.Model.InventoryControlAgent", b =>
                {
                    ...
                    b.ToTable("InventoryControlAgents", "wh", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Warehouse.Model.PropertyOfGoods", b =>
                {
                    ...
                    b.ToTable("PropertiesOfGoods", "wh", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Procurement.Model.PriceInquiryGoods", b =>
                {
                    ...
                    b.HasOne("Procurement.Model.PriceInquiry", "PriceInquiry")
                        .WithMany("PriceInquiryGoods")
                        .HasForeignKey("PriceInquiryId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("Goods");

                    b.Navigation("PriceInquiry");
                });
            ...
            modelBuilder.Entity("Procurement.Model.Seller", b =>
                {
                    b.HasOne("Warehouse.Model.Location", "City")
                        .WithMany()
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Warehouse.Model.Location", "Province")
                        .WithMany()
            ...
            modelBuilder.Entity("Procurement.Model.PriceInquiry", b =>
                {
                    b.Navigation("PriceInquiryGoods");
                });
