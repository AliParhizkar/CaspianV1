(function ($) {
    ...
    $t.dateView.prototype = {
        _createSharedCalendar: function () {
            if (!sharedCalendar) {
                ...
                var result = $t.fx._wrap(sharedCalendar).css('display', 'none');
                setTimeout(function () {
                    result.css({
    ...
    $t.datepicker = function (element, options) {
        ...
        $(element).mouseover(function () {
            if (!$(element).parent().hasClass('t-state-selected'))
        ...
        var $element = this.$element = $(element)
                    ...
                    .bind({
                        ...
                        focus: $.proxy(function (e) {
                            ...
                            $(e.target).parent().removeClass('t-state-hover').addClass('t-state-selected');
                            if (this.openOnFocus) {
                                this._open();
                            }
                            if (self.errorMessage)
                                $t.showErrorMessage($(element).closest('.t-widget')[0], self.errorMessage);
                        }, this)
                    });
    ...
    $t.datepicker.prototype = {
        ...
        filterForSearch: function () {
            var tempValue = this.value();
            if (tempValue == '')
                tempValue = null;
            if (this.isSes == true && this.oldValue != tempValue) {
