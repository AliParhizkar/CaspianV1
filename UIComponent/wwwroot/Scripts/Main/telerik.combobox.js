    ...
    $t.combobox = function (element, options) {
        ...
        this.fill = function (callback, options) {
            function updateSelection(component) {
                ...
                component.selectedIndex1 = selectedIndex;
        ...
        this.select = function (item) {
            ...
            if (index != -1) {
                ...
                if (index != this.selectedIndex1)
                    $(this.element).trigger('changeValue', dataItem.value);
                this.selectedIndex1 = (filteredDataIndexes != undefined && filteredDataIndexes.length > 0) ? filteredDataIndexes[index] : index;
            }
            return index;
        }
