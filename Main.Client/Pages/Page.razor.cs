...
namespace Caspian.Client
{
    public partial class Page: ComponentBase
    {
        ...
        [Parameter]
        public EventCallback<ReportSetting> OnReportSetting { get; set; }
        ...
        void InitializeData(double pixelPerCentimeter)
        {
            Data.PixelsPerCentimetre = pixelPerCentimeter;
            ...
            Data.Width = Convert.ToInt32(Data.Setting.PageWidth * Data.PixelsPerCentimetre);
        }
        ...
        [Parameter]
        public EventCallback OnControlSetting { get; set; }

        public async Task OpenTextWindow()
        {
            await OnControlSetting.InvokeAsync();
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            if (firstRender)
            {
                var pixelsPerCentimetre = await JSRuntime.InvokeAsync<double>("getPixelsPerCentimetre", null);
                InitializeData(pixelsPerCentimetre);
                StateChanged();
            }
            //if (Data != null)
